...
The version on GitHub is the command line version, but The GUI version of the BED-Craft tool is also available at <a href="https://keio-cmg.jp/BED-Craft">https://keio-cmg.jp/BED-Craft</a>.  
The most significant difference between the GUI version and the command-line version is whether other species beyond humans and mice are supported.  
